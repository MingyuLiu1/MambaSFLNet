...
import argparse
parser = argparse.ArgumentParser(description='Hyper-parameters for MambaLFNet')
...
model_restored = MambaLFNet()
model_restored = model_restored.cuda()
macs, params = get_model_complexity_info(model_restored, (3, 256, 256), as_strings=True, print_per_layer_stat=True, verbose=True)
